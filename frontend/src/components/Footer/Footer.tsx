...
export const Footer = () => {
	return (
		<div className='footer-container'>
			<p className='footer-attribute'>Image by <a className='footer-attribute-link' href="https://www.freepik.com/free-vector/minimal-geometric-landing-page_5934183.htm#query=landing%20page%20background&position=26&from_view=keyword">Freepik</a></p>
			{/* <div>Footer</div> */}
